...
class Blog8Page extends Component {
  state = {
    title: "",
    content: "",
    loading: true,
  ...
  componentDidMount() {
    ...
    axios
      .get("https://www.magemonkeys.com/wp-json/wp/v2/posts/5170")
      .then((res) =>
        this.setState({
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>Send Unique Coupon Code on Every New Subscriber</title>
          <link
            rel="canonical"
            href="https://www.magemonkeys.com/send-unique-coupon-code-on-every-new-subscriber/"
          ></link>
        </Helmet>
        <Header />
        <InnerBannerBd />
