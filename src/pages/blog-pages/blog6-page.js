...
class Blog6Page extends Component {
  state = {
    title: "",
    content: "",
    loading: true,
  ...
  componentDidMount() {
    ...
    axios
      .get("https://www.magemonkeys.com/wp-json/wp/v2/posts/5213")
      .then((res) =>
        this.setState({
    ...
    return (
      <div>
        <Helmet>
          ...
          <link
            rel="canonical"
            href="https://www.magemonkeys.com/in-magento-2-how-to-set-custom-price-for-products-in-cart/"
          ></link>
        </Helmet>
        <Header />
        <InnerBannerBd />
