...
class Blog2Page extends Component {
  state = {
    title: "",
    content: "",
    loading: true,
  ...
  componentDidMount() {
    ...
    axios
      .get("https://www.magemonkeys.com/wp-json/wp/v2/posts/5224")
      .then((res) =>
        this.setState({
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>How to get category count in Magento 2?</title>
          <link
            rel="canonical"
            href="https://www.magemonkeys.com/how-to-get-category-count-in-magento-2/"
          ></link>
        </Helmet>
        <Header />
        <InnerBannerBd />
